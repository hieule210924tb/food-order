...
<body class="chat-embed-page">
    <div class="chat-embed-shell">
        ...
        <header class="chat-embed-header">
            <button type="button" class="chat-float-close" id="chatEmbedCloseBtn"
                aria-label="Đóng chat">&times;</button>
        ...
        <div class="chat-embed-composer">
            <form id="chatForm" class="chat-embed-form">
                <input type="hidden" name="order_code" id="orderCode"
                    value="<?php echo htmlspecialchars($order_code, ENT_QUOTES, 'UTF-8'); ?>">
                <input type="text" class="chat-embed-input" id="messageInput" placeholder="Nhập tin nhắn..."
    ...
    <script>
        ...
        document.getElementById('chatForm').addEventListener('submit', function(e) {
            ...
            fetch(SITEURL + 'api/send-user-message.php', {
                    method: 'POST',
                    body: fd
                })
                .then(function(r) {
