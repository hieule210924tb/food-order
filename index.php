...
<section class="food-search text-center mt-3">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="best-grid">
            ...
            <div class="item">
                ...
                <button onclick="addToCart(<?php echo $id; ?>, <?php echo (float)$price; ?>)"
                    class="bi bi-cart-plus btn btn-primary mt-3">
                    Thêm vào giỏ
                </button>
            </div>
            <?php
    ...
    <div class="container">
        ...
        <div class="food-menu-box">
            ...
            <div class="food-menu-desc">
                ...
                <br>
                <button onclick="addToCart(<?php echo $id; ?>, <?php echo (float)$price; ?>)" class="btn btn-primary"><i
        ...
        if (isset($_SESSION[$key]) && !empty($_SESSION[$key])) {
            ...
            if (!empty($message)) {
                ...
                if (
                    ...
                    strpos(strtolower($_SESSION[$key]), 'access-denied') !== false ||
